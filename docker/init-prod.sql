...
-- 预定义标签（系统数据）
INSERT IGNORE INTO tags (name, description, color, icon, is_active, sort_order) VALUES
('美食', '分享美食体验', '#ff4d4f', 'food', TRUE, 1),
('旅行', '旅行见闻分享', '#52c41a', 'travel', TRUE, 2),
('摄影', '摄影作品展示', '#1890ff', 'camera', TRUE, 3),
('生活', '日常生活记录', '#722ed1', 'home', TRUE, 4),
('科技', '科技产品讨论', '#13c2c2', 'tech', TRUE, 5),
('娱乐', '娱乐休闲话题', '#eb2f96', 'entertainment', TRUE, 6),
('运动', '运动健身分享', '#fa8c16', 'sports', TRUE, 7),
('学习', '学习经验交流', '#fadb14', 'study', TRUE, 8);
